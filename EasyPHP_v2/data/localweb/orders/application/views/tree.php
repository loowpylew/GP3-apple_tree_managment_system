...
<header class="header_area">
  ...
  <textarea id="trees-Para" cols="0" rows="0">Here in the 'Customers' page, you can enter details about the customer such as assigning a unique ID to name, address, 
...
<p>Here in the 'Customers' page, you can enter details about the customer such as assigning a unique ID to name, address, phone number and email. You can add  new customers to the list 
   ...
   button and you can delete details about customers by <br> simply clicking on the 'delete' button<input onclick="treesPara()" type="button" value="Speak"></p></div> 

    <div id="trees-dbtable">
		<?php echo $output; ?>
    </div>
    ...
    <script> 
             ...
             document.getElementById('trees-Para').style.display = "none";

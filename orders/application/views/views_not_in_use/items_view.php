...
by simply clicking on the 'delete' button <input onclick="itemsPara()" type="button" value="Speak"></p></div> 
    ...
    <script>
        ...
        window.onload = function(){
            if(window.location.href == "http://localhost:8080/orders/index.php/main/items"){
            ...
            if(window.location.href == "http://localhost:8080/orders/index.php/main/items/add"){
            ...
            if(window.location.href == "http://localhost:8080/orders/index.php/main/items/read/420#"){
              document.getElementById('image-one').style.display = "none";
              document.getElementById('image-two').style.display = "none";
              document.getElementById('image-four').style.display = "none";
            }
            if(window.location.href == "http://localhost:8080/orders/index.php/main/items/edit/420#"){
              document.getElementById('image-one').style.display = "none";
              document.getElementById('image-two').style.display = "none";
              document.getElementById('image-three').style.display = "none";
            }

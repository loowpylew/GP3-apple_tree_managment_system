 ...
 <div id="orderLine_dbtable">
    ...
    <script>
        ...
        window.onload = function(){
            if(window.location.href == "http://localhost:8080/orders/index.php/main/orderline"){
            ...
            if(window.location.href == "http://localhost:8080/orders/index.php/main/orderline/add"){
              document.getElementById('image-one').style.display = "none"; 
              document.getElementById('image-three').style.display = "none";
              document.getElementById('image-four').style.display = "none";
            }
            if(window.location.href == "http://localhost:8080/orders/index.php/main/orderline/read/124"){
              document.getElementById('image-one').style.display = "none";
              document.getElementById('image-two').style.display = "none";
              document.getElementById('image-four').style.display = "none";
            }
            if(window.location.href == "http://localhost:8080/orders/index.php/main/orderline/edit/124"){
              document.getElementById('image-one').style.display = "none";
              document.getElementById('image-two').style.display = "none";
              document.getElementById('image-three').style.display = "none";
            }
            /////////////////////////////////////////////////////////////////////////////////////////////
            if(location.href == "http://localhost:8080/orders/index.php/main/orderline#"){
              document.getElementById('image-two').style.display = "none";
              document.getElementById('image-three').style.display = "none";
              document.getElementById('image-four').style.display = "none";
            }
